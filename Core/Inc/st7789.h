...
#define USING_240X240 // Make sure this is active

#ifdef USING_240X240
    #define ST7789_ROTATION 1  // Force Landscape for DSO

    #define ST7789_WIDTH  320  // Long side for 2.4"
    #define ST7789_HEIGHT 240  // Short side
    #define X_SHIFT 0
    #define Y_SHIFT 0
#endif
